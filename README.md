...
Discord-бот для пошуку сторінок українських Paradox-вікі. Дані лежать локально
в SQLite, тож пошук не залежить від доступності вікі.
...
Бази статичні й у репозиторії — скрипта оновлення поки немає.
