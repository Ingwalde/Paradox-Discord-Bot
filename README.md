...
Образ у GHCR — manifest list під `linux/amd64` і `linux/arm64`, тож той самий
тег `sha-<commit>` іде і на AMD-інстанс, і на Ampere. Це не косметика:
безкоштовна квота Oracle — лише два AMD micro-інстанси, тому третя дармова
машина може бути тільки ARM, і amd64-образ на ній не запуститься.
